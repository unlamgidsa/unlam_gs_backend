...
class __Bugsat1(KaitaiStruct):
    ...
    class Ax25Frame(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            if _parent!=None:
                self.tlmyinfo = _parent.tlmyinfo
            else:
                self.tlmyinfo = []
            self._io = _io
            self._parent = _parent
    ...
    class Telemetry(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.tlmyinfo.append( ('fixed_contents', self._io.pos(), None) )
            
            self.uptime_s = self._io.read_u4be()
            self.tlmyinfo.append(('uptime_s', self._io.pos(), "u4be"))
            
            self.rtc_s = self._io.read_u4be()
            self.tlmyinfo.append(('rtc_s', self._io.pos(), "u4be"))
            ...
            self.tlmyinfo.append(('low_voltage_counter', self._io.pos(), "u2be"))
            
            
            self.nice_battery_mv = self._io.read_u2be()
            self.tlmyinfo.append(('nice_battery', self._io.pos(), "u2be"))
            
            self.raw_battery_mv = self._io.read_u2be()
            self.tlmyinfo.append(('raw_battery', self._io.pos(), "u2be"))
            
            
            self.battery_amps = self._io.read_u2be()
            self.tlmyinfo.append(('battery_amps', self._io.pos(), "u2be"))
            
            self.pcm_3v3_v = self._io.read_u2be()
            self.tlmyinfo.append(('pcm_3v3_v', self._io.pos(), "u2be"))
            
            self.pcm_3v3_a = self._io.read_u2be()
            self.tlmyinfo.append(('pcm_3v3_a', self._io.pos(), "u2be"))
            
            self.pcm_5v_v = self._io.read_u2be()
            self.tlmyinfo.append(('pcm_5v_v', self._io.pos(), "u2be"))
            
            self.pcm_5v_a = self._io.read_u2be()
            self.tlmyinfo.append(('pcm_5v_a', self._io.pos(), "u2be"))
            
            self.thermal_tlm_id = self._io.ensure_fixed_contents(b"\x04\x01")
            
            
            self.cpu_c = self._io.read_s2be()
            self.tlmyinfo.append(('CPU_C', self._io.pos(), "s2be"))
            
            self.mirror_cell_c = self._io.read_s2be()
            self.tlmyinfo.append(('mirror_cell_c', self._io.pos(), "s2be"))
            
            
            self.aocs_tlm_id = self._io.ensure_fixed_contents(b"\x05\x01")
            
            self.mode = self._io.read_u4be()
            self.tlmyinfo.append(('aocs_mode', self._io.pos(), "u4be"))
            ...
            self.tlmyinfo.append(('magnetometer_x', self._io.pos(), "s2be"))
            
            self.magnetometer_y_mg = self._io.read_s2be()
            self.tlmyinfo.append(('magnetometer_y', self._io.pos(), "s2be"))
            
            self.magnetometer_z_mg = self._io.read_s2be()
            self.tlmyinfo.append(('magnetometer_z', self._io.pos(), "s2be"))
            
            
            self.gyro_x_dps = self._io.read_s2be()
            self.tlmyinfo.append(('gyro_x', self._io.pos(), "s2be"))
            
            self.gyro_y_dps = self._io.read_s2be()
            self.tlmyinfo.append(('gyro_y', self._io.pos(), "s2be"))
            
            self.gyro_z_dps = self._io.read_s2be()
            self.tlmyinfo.append(('gyro_z', self._io.pos(), "s2be"))
            
            self.temperature_imu_c = self._io.read_s2be()
            self.tlmyinfo.append(('temp_imo_c', self._io.pos(), "s2be"))
            
            self.fine_gyro_x_dps = self._io.read_s4be()
            self.tlmyinfo.append(('fine_gyro_x', self._io.pos(), "s4be"))
            
            self.fine_gyro_y_dps = self._io.read_s4be()
            self.tlmyinfo.append(('fine_gyro_y', self._io.pos(), "s4be"))
            
            self.fine_gyro_z_dps = self._io.read_s4be()
            self.tlmyinfo.append(('fine_gyro_z', self._io.pos(), "s4be"))
            
            
            self.wheel_1_radsec = self._io.read_s2be()
            self.tlmyinfo.append(('wheel_1', self._io.pos(), "s2be"))
            
            self.wheel_2_radsec = self._io.read_s2be()
            self.tlmyinfo.append(('wheel_2', self._io.pos(), "s2be"))
            
            self.wheel_3_radsec = self._io.read_s2be()
            self.tlmyinfo.append(('wheel_3', self._io.pos(), "s2be"))
            
            self.wheel_4_radsec = self._io.read_s2be()
            self.tlmyinfo.append(('wheel_4', self._io.pos(), "s2be"))
            
            
            self.payload_tlm_id = self._io.ensure_fixed_contents(b"\x06\x01")
            
            self.experiments_run = self._io.read_u2be()
            self.tlmyinfo.append(('experiments_run', self._io.pos(), "u2be"))
            
            self.experiments_failed = self._io.read_u2be()
            self.tlmyinfo.append(('experiments_failed', self._io.pos(), "u2be"))
            
            self.last_experiment_run = self._io.read_s2be()
            self.tlmyinfo.append(('last_experiment_run', self._io.pos(), "s2be"))
            
            self.current_state = self._io.read_u1()
            self.tlmyinfo.append(('current_state', self._io.pos(), "u1"))
